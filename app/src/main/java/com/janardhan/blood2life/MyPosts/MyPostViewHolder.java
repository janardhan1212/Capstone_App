...
public class MyPostViewHolder extends RecyclerView.ViewHolder {
    ...
    p_MyCustomTextView_mbold status;

    public MyPostViewHolder(View itemView) {
        super(itemView);
        mView = itemView;
        mPhotoView = (ImageView) itemView.findViewById(R.id.profilePic);
        ...
        status=(p_MyCustomTextView_mbold) itemView.findViewById(R.id.status);
        ...
        itemView.findViewById(R.id.status_ll).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.submit_status(status_ll);
    ...
    public void setBg() {
        status_ll.setBackgroundColor(Color.parseColor("#3eb74e"));
    }

    public void setText(final String name, String loc, String phno, String bld_grp, String msg, String received) {
    ...
    public interface PostClickListener {
        ...
        void submit_status(LinearLayout status_ll);
    }
}